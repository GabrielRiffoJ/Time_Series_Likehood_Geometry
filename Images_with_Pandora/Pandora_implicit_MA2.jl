...
fa0_str = replace(fa0, "a_0" => "a0","a_1" => "a1","a_2" => "a2","y_[1]" => "y[1]", "y_[2]" => "y[2]", "y_[3]" => "y[3]", "y_[4]" => "y[4]", "y_[5]" => "y[5]","y_[6]" => "y[6]","y_[7]" => "y[7]","y_[8]" => "y[8]","y_[9]" => "y[9]","y_[10]" => "y[10]")
fa1_str = replace(fa1, "a_0" => "a0","a_1" => "a1","a_2" => "a2","y_[1]" => "y[1]", "y_[2]" => "y[2]", "y_[3]" => "y[3]", "y_[4]" => "y[4]", "y_[5]" => "y[5]","y_[6]" => "y[6]","y_[7]" => "y[7]","y_[8]" => "y[8]","y_[9]" => "y[9]","y_[10]" => "y[10]")
fa2_str = replace(fa2, "a_0" => "a0","a_1" => "a1","a_2" => "a2","y_[1]" => "y[1]", "y_[2]" => "y[2]", "y_[3]" => "y[3]", "y_[4]" => "y[4]", "y_[5]" => "y[5]","y_[6]" => "y[6]","y_[7]" => "y[7]","y_[8]" => "y[8]","y_[9]" => "y[9]","y_[10]" => "y[10]")
...
E = EnumerativeProblem([fa0_expr,fa1_expr, fa2_expr], variables=[a0,a1, a2], parameters=vcat(y[1:n]), torus_only=true)
...
#savefig(P2, "MA2_gamma_6.png")
#savefig(P2, "MA2_an5.pdf")

#savefig(P2, "MA2_an4_1.png")

#save(P2, "MA2_an3.png")

using Plots: savefig
#savefig(P2, "MA2_an4.png")
#savefig(P2, "MA2_an4.pdf")


import GR

#GR.savefig("MA2_an3.png")
